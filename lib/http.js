...
// FIXME: add separate file with `contextDocumentLoader` that can be
// created via a `config` and a `serviceType` (required to get the
// document store) -- then lookup context URL using document store
